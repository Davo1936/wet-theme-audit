# WET Premium Shopify Theme Replacement

Target: unpublished Shopify theme `183655891231`.

This source set replaces the previous Direction 01 custom layer with a WET-specific implementation based on Brand Profile v1.1.

It includes:

- Official logo-only header treatment
- Black, red, burgundy, silver and white design system
- Condensed editorial typography
- Smooth WET curve language
